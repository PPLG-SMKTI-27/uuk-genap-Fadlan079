        ...
        <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="w-full md:w-2/3 space-y-2">
                ...
                <p class="text-gray-200 text-xs md:text-sm max-w-md leading-relaxed">
                    Anda login sebagai <strong class="text-secondary">Administrator</strong>. Pantau metrik performa toko dan stok barang secara real-time.
                </p>
            </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div class="bg-white p-4 rounded-lg shadow-sm border-l-4 border-purple-500 flex items-center justify-between hover:shadow-md transition">
            <div class="space-y-1">
                ...
                <p class="text-base font-extrabold text-text truncate max-w-[120px]" title="Rp {{ number_format($totalRevenue, 0, ',', '.') }}">
        ...
        <!-- Stat card 5: Total Petugas (Admin Only) -->
        <div class="bg-white p-4 rounded-lg shadow-sm border-l-4 border-amber-500 flex items-center justify-between hover:shadow-md transition col-span-1 sm:col-span-2 lg:col-span-1">
            <div class="space-y-1">
                <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">Petugas</span>
                <p class="text-2xl font-extrabold text-text">{{ $totalUsers }}</p>
            </div>

        ...
        <div class="relative z-10 px-4 py-6 md:px-8 md:py-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="w-full md:w-2/3 space-y-2">
                <h2 class="text-2xl md:text-3xl font-extrabold text-white leading-tight tracking-tight">
                    Ubah Informasi<br>
                    <span class="text-secondary">Petugas: {{ $user->name }}</span>
                </h2>
                <p class="text-gray-200 text-xs md:text-sm max-w-md leading-relaxed">
                    Perbarui data petugas. Kosongkan kolom kata sandi jika tidak ingin mengubahnya.
                </p>
            </div>
        </div>
    </div>
...
<section class="p-5 pt-0">
    <div class="bg-white rounded-lg shadow-md border-t-[5px] border-primary max-w-2xl mx-auto">
        ...
        <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
            ...
            <div>
                <h3 class="font-bold text-text text-base">Formulir Pembaruan Petugas</h3>
            </div>
        </div>
        ...
        <form action="{{ route('user.update', $user->id) }}" method="POST" class="p-6 space-y-5">
            ...
            <div class="space-y-1.5">
                <label for="name" class="block font-bold text-sm text-text">
                ...
                <input type="text"
                       ...
                       class="w-full p-2.5 rounded border @error('name') border-red-500 focus:ring-red-500/20 focus:border-red-500 @else border-gray-300 focus:ring-primary/20 focus:border-primary @enderror"
            ...
            <div class="space-y-1.5">
                <label for="email" class="block font-bold text-sm text-text">
                ...
                <input type="email"
                       ...
                       class="w-full p-2.5 rounded border @error('email') border-red-500 focus:ring-red-500/20 focus:border-red-500 @else border-gray-300 focus:ring-primary/20 focus:border-primary @enderror"
            ...
            <div class="space-y-1.5">
                <label for="role" class="block font-bold text-sm text-text">
                    Hak Akses / Role <span class="text-red-500">*</span>
                </label>
                <select name="role"
                        id="role"
                        class="w-full p-2.5 rounded border @error('role') border-red-500 focus:ring-red-500/20 focus:border-red-500 @else border-gray-300 focus:ring-primary/20 focus:border-primary @enderror"
                        required>
            ...
            <div class="space-y-1.5">
                <label for="password" class="block font-bold text-sm text-text">
                    Kata Sandi Baru <span class="text-gray-400 font-normal text-xs">(Kosongkan jika tidak ingin mengubah)</span>
                </label>
                <input type="password"
                       name="password"
                       id="password"
                       class="w-full p-2.5 rounded border @error('password') border-red-500 focus:ring-red-500/20 focus:border-red-500 @else border-gray-300 focus:ring-primary/20 focus:border-primary @enderror"
            ...
            <div class="space-y-1.5">
                <label for="password_confirmation" class="block font-bold text-sm text-text">
                    Konfirmasi Kata Sandi Baru
                </label>
                <input type="password"
                       name="password_confirmation"
                       id="password_confirmation"
                       class="w-full p-2.5 rounded border border-gray-300 focus:ring-primary/20 focus:border-primary"

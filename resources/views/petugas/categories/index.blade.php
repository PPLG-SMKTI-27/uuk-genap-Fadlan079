        ...
        <div class="relative z-10 px-4 py-8 md:px-8 md:py-10 flex flex-col md:flex-row justify-between items-center gap-8">
            <div class="w-full md:w-2/3 space-y-4">
                <h2 class="text-3xl md:text-4xl font-extrabold text-white leading-tight tracking-tight">
                    Daftar Kategori Produk<br>
                </h2>
                <p class="text-gray-200 text-sm md:text-base max-w-md leading-relaxed">
                    Manajemen dan monitoring kategori produk anda.
                </p>
            </div>
                                    ...
                                    <div class="flex items-center justify-center gap-1.5">
                                        <form action="{{ route('kategori.destroy', $c->id) }}" method="POST">
                                            ...
                                            <button type="submit"
                                                ...
                                                class="p-1.5 bg-danger/20 hover:bg-danger/40 text-danger rounded transition" title="Hapus Kategori">
                                                <i class="fa-solid fa-trash text-[10px]"></i>
                                            </button>
                                        </form>
                                        <a href="{{ route('kategori.edit', $c->id) }}" class="p-1.5 bg-primary/10 hover:bg-primary/20 text-primary rounded transition" title="Edit Siswa">
